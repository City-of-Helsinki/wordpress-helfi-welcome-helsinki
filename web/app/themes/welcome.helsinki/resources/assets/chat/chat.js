...
helFiChat_closed_button = 'background-image: url(\"https://www.hel.fi/static/helsinki/chat/chat-closed-en.png\") !important';
/* changed to off-line button: */
helFiChat_open_button = 'background-image: url(\"https://www.hel.fi/static/helsinki/chat/chat-open-en.png\") !important';
/* offline-button: */
// helFiChat_open_button = 'background-image: url(\"chat-open-en.png\") !important';
...
if (helFiChat_localization == '') {
  ...
  helFiChat_localization = 'https://asiointi.hel.fi/chat/kanslia/custom/chat-virkainfo-en.json';
  helFiChat_serverUrl = 'https://asiointi.hel.fi/chat/kanslia/cobrowse';
  helFiChat_service = 'VIRKAINFO';
  helFiChat_language = 'EN';
  helfiChat_GUI_lang = helFiChat_language;
  helFiChat_title_temp = 'Helsinki-info Chat';
  helFiChat_variant = 'new';
  helfiChatCookiePath = '';
  ...
  /* OFFLINE VERSION: */
  // helfiChatButtonCloseElement = '<img class="gwc-chat-icon-iks" onkeypress="onEnter(event, this)" tabindex="0" role="button"' + helfiChat_close + 'src="close-next.svg" style="width: 100%\;width:35px\;cursor:pointer\;"/>';
  // helfiChatButtonCloseElementFromMobileView = '<div class="gwc-chat-icon-iks-mobile" tabindex="0" role="button" onkeypress="onEnter(event, this)" onclick="removeChatIcon()"><img ' + helfiChat_close_mobile + 'src="close-next.svg" style="width: 100%\;width:35px\;cursor:pointer\;"/><div>';
        ...
        onBeforeChat: function (chat) {
          ...
          _genesys.chat.onReady.push(function (chatWidgetApi) {
            chatWidgetApi.restoreChat({
              ...
              setTimeout(function () {
                $('.gwc-chat-btn').on("click", function () {
              ...
              session.onMessageReceived(function (event) {
                ...
                if (event.party.type.client) {
                  ...
                  $(".gwc-chat-message-author").last().siblings(".gwc-chat-message-text").each(function () {
    ...
    setTimeout(function () {
      ...
      */
      ...
      if (window.innerWidth <= 575 || window.innerHeight <= 425) {
        ...
        $('.gwc-chat-icon-iks').click(function () {
          $(".gcb-startBtnsContainer").prepend(helfiChatButtonCloseElementFromMobileView);
        });
...
function toggleFlip() {
  ...
  $('.gwc-chat-icon-down').attr('aria-label', function (index, attr) {
    return attr == arrowUpAriaLabel ? arrowDownAriaLabel : arrowUpAriaLabel;
  });
  $('.gwc-chat-icon-down').attr('title', function (index, attr) {
    return attr == arrowUpTitle ? arrowDownTitle : arrowUpTitle;
  });
  $('.gwc-chat-icon-down').attr('alt', function (index, attr) {
